...
#  define MY_NODE_MODULE_CONTEXT      isolate->GetCurrentContext()
...
#  define V8_DATE_NEW(value)   v8::Date::New(MY_NODE_MODULE_CONTEXT, value).ToLocalChecked()
#  define V8_STRING_NEW_UTF8(value)   v8::String::NewFromUtf8(MY_NODE_MODULE_ISOLATE_PRE value, v8::NewStringType::kNormal).ToLocalChecked()
#  define V8_STRING_NEW_2BYTES(value)   v8::String::NewFromTwoByte(MY_NODE_MODULE_ISOLATE_PRE value, v8::NewStringType::kNormal).ToLocalChecked()
...
#  define V8_DATE_NEW(value)   v8::Date::New(MY_NODE_MODULE_CONTEXT, value).ToLocalChecked()
#  define V8_STRING_NEW_UTF8(value)   v8::String::New(MY_NODE_MODULE_ISOLATE_PRE value, v8::NewStringType::kNormal).ToLocalChecked()
#  define V8_STRING_NEW_2BYTES(value)   v8::String::New(MY_NODE_MODULE_ISOLATE_PRE value, v8::NewStringType::kNormal).ToLocalChecked()
...
#define V8_STR_CONC(left, right)                              \
	v8::String::Concat(V8_STRING_NEW_UTF8(left), V8_STRING_NEW_UTF8(right)).ToLocalChecked()
...
#define REQUIRE_ARGUMENT_STRING(args, i, var)                                        \
    ...
    v8::String::Utf8Value var(args.GetIsolate(), args[i]->ToString(args.GetIsolate()->GetCurrent()->GetCurrentContext()).ToLocalChecked());                            \

#define REQUIRE_ARGUMENT_STRINGW(args, i, var)                              \
    ARG_CHECK_STRING(args, i);                                                       \
    v8::String::Value var(args.GetIsolate(), args[i]->ToString(args.GetIsolate()->GetCurrent()->GetCurrentContext()).ToLocalChecked());                               \
    
#define REQUIRE_ARGUMENT_STRINGV8(args, i, var)                            \
    ARG_CHECK_STRING(args, i);                                                      \
    v8::Local<v8::String> var = (args[i]->ToString(args.GetIsolate()->GetCurrent()->GetCurrentContext()).ToLocalChecked());  \
